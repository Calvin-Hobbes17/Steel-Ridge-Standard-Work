...
!!! quote
    ...
    In general, an FRC robot is too complicated and has too many parts to be created entirely within a single document. Doing so is possible, but will result in bad loading times, and likely poor organization." - [FRCDesign](https://frcdesign.org/best-practices/document-setup/)
