...
-   :lucide-brain-circuit:{ .lg .middle } **Learn CAD**

    ---
    Learn CAD with the FRCDesign learning course.

    :octicons-arrow-right-24: [Learn CAD](https://frcdesign.org "FRCDesign")

</div>

<div class="grid cards" markdown>

-   :lucide-ruler:{ .lg .middle } **Design standards**
