...
To dimension a belt, use the dimension tool on the **center** line between the pulleys. Similar to dimensioning a pulley, type #Belt and select #beltCTC_5mm()
...
Open the featurescript in your part studio, and select the two pulleys the belt is dimensioned to. Double check that the width is 9mm, and the pitch is HTD5mm, and hit check. Don't worry about offsets.
