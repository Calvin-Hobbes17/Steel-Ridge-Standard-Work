...
-   :lucide-code-xml:{ .lg .middle } **Programming**

    ---
    The worst subteam (joking i swear)

    :lucide-arrow-right: [Program Stuff, I guess](https://tinyurl.com/4peyhf8r)

-   :lucide-box:{ .lg .middle } **Design**
...
-   :lucide-pencil:{ .lg .middle } **Contributing**
